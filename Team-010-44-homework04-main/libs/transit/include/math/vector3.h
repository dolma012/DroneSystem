...
class Vector3 {
 public:
  ...
  /**
   * @brief Overides [] operators
   * @param[in] index the index of the Vector3 object
   * @return corresponding x,y, or z float reference
  */
   ...
   * @brief Overides [] operators
   * @param[in] index the index of the Vector3 object
   * @return corresponding x,y, or z float
  */
  ...
  */
  ...
  /**
   * @brief Calculates the Unit of the Vector3
   * @return return a Vector3 unit
  */
  Vector3 Unit() { return (*this) / Magnitude(); }

  /**
   * @brief Calculate the distance between two Vector3 objects
   * @return the distance between two Vector3 objects
  */
